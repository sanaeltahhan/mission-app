...
public class InsererMission implements Runnable {
	...
	mission2.setDateDebut(LocalDate.of(2019, 5, 5));
	mission2.setDateFin(LocalDate.of(2019, 6, 6));
	this.missionRepository.save(mission2);
	
	Mission mission3 = new Mission();
	mission3.setLibelle("Mission 3");
	mission3.setTauxJournalier(new BigDecimal("300.90"));
	mission3.setDateDebut(LocalDate.of(2019, 4, 4));
	mission3.setDateFin(LocalDate.of(2019, 7, 7));
	this.missionRepository.save(mission3);*/
	
	Mission mission4 = new Mission();
	mission4.setLibelle("Mission 4");
	mission4.setTauxJournalier(new BigDecimal("300.90"));
	mission4.setDateDebut(LocalDate.of(2020, 9, 9));
	mission4.setDateFin(LocalDate.of(2020, 10, 10));
